...
Public Running                                As Boolean
 Global logType(1 To 10) As String
...
Private Max, Min
#End If
Dim timestampaa As Variant
Public Const FileTypesofInterrest             As String = "EXEBATCOMPIFDOCVBS.JS"
#If False Then 'Trick preserves Case of Enums when typing in IDE
Private Executable, Script
#End If
...
Public Declare Function WindowFromPoint Lib "User32" (ByVal lpPointX As Long, _
                                                      ByVal lpPointY As Long) As Long
